...
bool RegType::CanAssignArray(RegType& src, RegTypeCache& reg_types,
  ...
  RegType& cmp1 = reg_types.GetComponentType(*this, class_loader.Get());
  RegType& cmp2 = reg_types.GetComponentType(src, class_loader.Get());
